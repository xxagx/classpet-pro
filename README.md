...
> **Fork 自**: [xxagx/classpet-pro1.0](https://github.com/xxagx/classpet-pro1.0)  
> **原项目**: 班级宠物养成系统 - 为教室希沃触摸一体机开发的班级互动宠物养成系统
...
- **[响应式设计指南](RESPONSIVE_GUIDE.md)** - 详细的响应式设计原理和断点系统说明
- **[部署指南](DEPLOYMENT.md)** - 部署到 GitHub Pages 的完整步骤
- **[设计系统](DESIGN_SYSTEM.md)** - 设计规范和组件库
